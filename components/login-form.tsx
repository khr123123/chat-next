      ...
      >
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-5">
          ...
          <motion.div variants={itemVariants} className="flex flex-col gap-2">
            ...
            <input
              ...
              disabled={busy}
              className="w-full rounded-md border border-slate-200 bg-white px-4 py-3 text-[14px] text-slate-900 placeholder:text-slate-400 focus:border-[#FDBA5E] focus:outline-none focus:ring-1 focus:ring-[#FDBA5E] transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
          ...
          <motion.div variants={itemVariants} className="flex flex-col gap-2">
            ...
            <div className="relative">
              <input
                ...
                disabled={busy}
                className="w-full rounded-md border border-slate-200 bg-white px-4 py-3 pr-10 text-[14px] font-mono text-slate-900 placeholder:text-slate-400 focus:border-[#FDBA5E] focus:outline-none focus:ring-1 focus:ring-[#FDBA5E] transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
                placeholder="••••••••"
              />
              <button
                type="button"
          ...
          <motion.div variants={itemVariants} className="flex items-center justify-between mt-1">
            <div className="flex items-center gap-2.5">
              <input
                ...
                type="checkbox"
                disabled={busy}
                className="size-[18px] rounded border-slate-300 text-[#FDBA5E] focus:ring-[#FDBA5E] transition-colors disabled:opacity-50"
              />
            ...
            <a
              href="#"
              className="text-[14px] font-medium text-slate-800 underline decoration-slate-800 underline-offset-4 transition-colors hover:text-black hover:decoration-black"
            >
              Forgot password?
            </a>
          </motion.div>
        ...
        <motion.div variants={itemVariants} className="mt-4">
          ...
          >
            ...
            {oauthProvider === "google" ? "Connecting…" : "Sign in with Google"}
          </button>
        </motion.div>
